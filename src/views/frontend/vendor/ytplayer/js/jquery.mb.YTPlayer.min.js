...
! function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        changeVideo: function(a) {
            var b = this,
                c = b.get(0);
            return c.opt.startAt = 0, c.opt.stopAt = 0, c.opt.mask = !1, c.opt.mute = !0, c.opt.autoPlay = !0, c.opt.addFilters = !1, c.hasData = !1, c.hasChanged = !0, c.player.loopTime = void 0, a && jQuery.extend(c.opt, a), c.videoID = getYTPVideoID(c.opt.videoURL).videoID, c.opt.loop && (c.opt.loop = 9999), jQuery(c.playerEl).CSSAnimate({
                opacity: 0
                ...
                }), jQuery(c).optimizeDisplay(), b.YTPCheckForState(), jQuery.mbYTPlayer.getDataFromAPI(c)
